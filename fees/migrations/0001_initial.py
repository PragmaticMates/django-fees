    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purchaser', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='plan', related_query_name='plan', to=settings.AUTH_USER_MODEL, verbose_name='purchaser')),
            ],
            options={
                'verbose_name': 'Plan',
